        ...
        public static void Initialize()
        {
            items = new List<MenuItem>
            {
                ...
                new VolumeItem("Wall Bump Volume",
                    () => FFI_ScreenReaderMod.WallBumpVolume,
                    FFI_ScreenReaderMod.SetWallBumpVolume),
                new VolumeItem("Footstep Volume",
                    () => FFI_ScreenReaderMod.FootstepVolume,
                    FFI_ScreenReaderMod.SetFootstepVolume),
                new VolumeItem("Wall Tone Volume",
                    () => FFI_ScreenReaderMod.WallToneVolume,
                    FFI_ScreenReaderMod.SetWallToneVolume),
                new VolumeItem("Beacon Volume",
                    () => FFI_ScreenReaderMod.BeaconVolume,
                    FFI_ScreenReaderMod.SetBeaconVolume),
                ...
                new EnumItem("Enemy HP Display",
                    ...
                    () => FFI_ScreenReaderMod.EnemyHPDisplay,
                    FFI_ScreenReaderMod.SetEnemyHPDisplay),
            ...
            try
            {
                if (!enabled)
                {
                    ...
                    focusBlockerHandle = CreateWindowEx(
                        ...
                        "FFI_ModMenu",     // Window name (invisible)
