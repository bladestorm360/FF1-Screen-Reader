@echo off
REM FF1 Ghidra Headless Analysis Script
...
REM     magic        - Decompile magic/ability functions
REM     mapexits     - Decompile map exit and entity resolution functions
REM   mode:
...
REM   run_ghidra_analysis.bat mapexits              - Import + decompile map exits
REM   run_ghidra_analysis.bat mapexits analyze      - Re-analyze existing project for map exits
...
set "PROJECT_NAME=FF1_Analysis"
set "GAME_DIR=D:\Games\steamlibrary\steamapps\common\Final Fantasy PR"
...
if /i "%~1"=="mapexits" set "SCRIPT_TYPE=mapexits"
if /i "%~1"=="analyze" (
    set "MODE=analyze"
...
) else if "%SCRIPT_TYPE%"=="mapexits" (
    set "SCRIPT_FILE=%SCRIPT_DIR%decompile_mapexits.py"
    set "OUTPUT_FILE=%SCRIPT_DIR%decompiled_mapexits.c"
    set "SCRIPT_NAME=decompile_mapexits.py"
) else (
...
REM ============================================================================
echo ======================================================================
echo FF1 Ghidra Headless Analysis
echo ======================================================================
echo.
